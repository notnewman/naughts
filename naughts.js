...
function xpr(){
	...
	faira[0] = cell[1]*cell[2];
	faira[1] = cell[0]*cell[2];
	faira[2] = cell[0]*cell[1];
	faira[3] = cell[4]*cell[5];
	faira[4] = cell[5]*cell[3];
	faira[5] = cell[3]*cell[4];
	faira[6] = cell[7]*cell[8];
	faira[7] = cell[6]*cell[8];
	faira[8] = cell[6]*cell[7];
	fairb[0] = cell[3]*cell[6];
	fairb[1] = cell[4]*cell[7];
	fairb[2] = cell[5]*cell[8];
	fairb[3] = cell[0]*cell[6];
	fairb[4] = cell[1]*cell[7];
	fairb[5] = cell[2]*cell[8];
	fairb[6] = cell[0]*cell[3];
	fairb[7] = cell[1]*cell[4];
	fairb[8] = cell[2]*cell[5];
	fairc[0] = cell[4]*cell[8];
	fairc[2] = cell[4]*cell[6];
	fairc[4] = cell[0]*cell[8];
	fairc[6] = cell[4]*cell[2];
	fairc[8] = cell[0]*cell[4];
	faird[4] = cell[2]*cell[6];
	cat0 = row1*row2*row3;
